...
- **Expanded Summary:** This lesson introduces core concepts of Aligning Graduate Medical Education with Organizational Quality & Safety Goals and how to operationalize them. This expanded module links the concept to Saudi operational realities, multidisciplinary communication, and measurable service outcomes.
...
| Residency program | برنامج الإقامة الطبية |
| Milestones | المعالم التطورية للكفاءة |
| Faculty development | تطوير هيئة التدريس |
| Curriculum design | تصميم المنهج التدريبي |
| QI portfolio | ملف تحسين الجودة |
| Simulation training | التدريب على المحاكاة |
| Direct observation | الملاحظة المباشرة |
| Scholarly activity | النشاط الأكاديمي |
| Competency assessment | تقييم الكفاءة |
| Learning environment | بيئة التعلم السريري |

## References & Resources | المراجع والموارد
- IHI Open School course source: https://www.ihi.org/learn/courses/open-school/catalog/gme-204
...
- ACGME Clinical Learning Environment Review: https://www.acgme.org/what-we-do/initiatives/cler/
- MOH Training & Scholarship Programs: https://www.moh.gov.sa
...
- [ ] Include a structured QI project in each resident's annual learning plan.
- [ ] Present at least one resident-led improvement project at the department's monthly meeting.
- [ ] Submit an annual GME QI report to your program director and institutional quality committee.
...
- [ ] رفع النتائج لهيكل حوكمة الجودة ووضع خطة توسع للدورة التالية.- [ ] تضمين مشروع تحسين جودة منظم في الخطة التعليمية السنوية لكل مقيم.
- [ ] تقديم مشروع تحسين واحد بقيادة المقيمين في الاجتماع الشهري للقسم.
- [ ] تقديم تقرير تحسين الجودة السنوي للتعليم الطبي إلى مدير البرنامج ولجنة الجودة المؤسسية.
